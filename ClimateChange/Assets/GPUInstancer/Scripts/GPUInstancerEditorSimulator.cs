    ...
    public class GPUInstancerEditorSimulator
    {
        ...
        public void StopSimulation()
        {
            ...
            if (GPUInstancerConstants.gpuiSettings.isLWRP || GPUInstancerConstants.gpuiSettings.isHDRP)
                ...
                UnityEngine.Rendering.RenderPipelineManager.beginCameraRendering -= CameraOnBeginRenderingSRP;
#else
...
#if UNITY_2019_1_OR_NEWER
        private void CameraOnBeginRenderingSRP(UnityEngine.Rendering.ScriptableRenderContext context, Camera camera)
        {
